...
export default function Menu() {
	...
	return (
		<>
			<div className="text-primaryText lg:pt-5 flex flex-col justify-between h-full">
				<div>
					<div className="mb-10 hidden xl:block px-2">
						<svg
					...
					<div>
						<ul className="text-md flex list-none max-lg:justify-between lg:block lg:space-y-2">
							<li
							...
							>
								<Link
									href="/"
									className="flex h-8 cursor-pointer items-center space-x-4 rounded-lg px-2 py-6 hover:bg-side_bar_hover"
								>
									<svg
										aria-label="Home"
							...
							<li
								...
								className="hidden lg:flex h-8 cursor-pointer items-center space-x-4 rounded-lg px-2 py-6 hover:bg-side_bar_hover lg:order-none"
							>
								<svg
									aria-label="New post"
									className="x1lliihq x1n2onr6 x5n08af"
								...
								>
									<div className="text-white">
										<div className="relative w-[24px] aspect-square">
											<svg viewBox="0 0 140 140" className="icon">
												<defs>
													<linearGradient
														id="border-gradient"
														x1="0%"
				...
				<div>
					<ul className="hidden text-md list-none max-lg:justify-between lg:block lg:space-y-2">
						<li className="order-1 lg:order-none">
							<Link
								href="/"
								className="flex h-8 cursor-pointer items-center space-x-4 rounded-lg px-2 py-6 hover:bg-side_bar_hover"
							>
								...
								<p className="hidden lg:block">Threads</p>
							</Link>
						</li>
						<li className="order-1 lg:order-none">
							<Link
